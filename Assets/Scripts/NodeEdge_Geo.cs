...
public class NodeEdge_Geo : MonoBehaviour
{
public Transform origin; // nodo principal
    public Transform core; // contenedor de nodos hijos
    ...
    void Update()
    {
            ...
            {
                p0 = nodeParent.InverseTransformPoint(origin.position);
                p2 = core.localPosition;
                p1 = (p0 + p2) / 4;
                p3 = p1 * 3;
